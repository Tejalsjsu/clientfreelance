...
class PastWorkFreelancer extends Component {
    constructor(props){
        super(props);
    }
        ...
        API.fetchProjects(this.state.userId)
            .then((res) => {
                ...
                if (res.status === '201') {
                    ...
                    this.props.history.push('/PastWorkFreelancer');
        ...
        return(
            <div>
                        ...
                        <div className="container">
                            ...
                            <div className="text-left">
                                ...
                                <div className="dashboard_tab_wrapper">
                                    ...
                                    <div className="dashboard_tab tab-clicked"><NavLink to="/PastProjectFreelancer">Past Work</NavLink> </div>
                                </div>
                                ...
                                <table className='ProjectTable'>
                                    ...
                                    <tr>
                                        ...
                                        <th className='ProjectTable-header'>OUTCOME</th>
                                    </tr>
                ...
                <Route exact path="/ActiveBidsFreelancer" render = {() => (
                    ...
                    <div>
                        <ActiveBidsFreelancer />
                    </div>
                )}/>
                <Route exact path="/myprojects" render = {() => (

                    <div>
                        <OpenProjectsEmployee />
                    </div>
                )}/>
...
export default withRouter(PastWorkFreelancer);