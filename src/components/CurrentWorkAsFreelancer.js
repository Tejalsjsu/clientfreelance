    ...
    render(){
        ...
        return(
            <div>
                    ...
                    <div className="page">
                        <div className="container">
                            ...
                            <div className="text-left">
                                ...
                                <div className="dashboard_tab tab-clicked"> <NavLink to="/CurrentWorkAsFreelancer">Current Work</NavLink></div>
                ...
                <Route  path="/ActiveBidsFreelancer" render = {() => (

                    <div>
                        <ActiveBidsFreelancer />
                    </div>
                )}/>
                <Route  path="/PastWorkFreelancer" render = {() => (
